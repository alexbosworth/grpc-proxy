...
// Get a quote for a Loop Out
func loopOutQuote(c *gin.Context) {
	...
	if connectErr != nil {
		c.JSON(
			...
			gin.H{"details": "FailedToConnectToSwapServerForLoopOutQuote"},
		)
		return
	}
	...
	grpcResponse, loopErr := client.LoopOutQuote(
